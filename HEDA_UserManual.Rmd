...
HPK_Q <- read.table("D:/Ninalty/UCD_Hydropeaking/HPK_FlowData/HPK_WC/CA/11278400.csv", sep = ",",header = TRUE, row.names = NULL)
head(HPK_Q)
```
***
...
```
HpkFrqMgt        Extract frequency and magnitude metrics
```
...
```
HpkRtDur        Extract rate of change and duration related metrics
```
